...
public class ErreklamatuGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ErreklamatuGUI(String email, JFrame pantaila, int saleNumber) {
		nirePantaila = this;
		...
		JButton erreklamatuBotoia = new JButton(ResourceBundle.getBundle("Etiquetas").getString("ErreklamatuGUI.claim"));
